...
int main() {
  ...
  std::chrono::duration<double, std::milli> isort_duration = isort_end - isort_start;
  std::chrono::duration<double, std::milli> msort_duration = msort_end - msort_start;

  std::cout << "\nIt took insertion_sort " << isort_duration.count() << " milliseconds to execute.";
  std::cout << "\nIt took merge_sort " << msort_duration.count() << " milliseconds to execute.";
}
